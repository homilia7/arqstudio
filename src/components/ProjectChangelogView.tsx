    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6 animate-fadeIn">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
          ...
          <div className="flex items-center space-x-2 shrink-0">
            <button
              ...
              className="px-3.5 py-2 bg-zinc-800/80 hover:bg-zinc-800 text-zinc-200 rounded-xl text-xs font-bold transition-all shadow-sm border border-zinc-700 flex items-center space-x-2 cursor-pointer"
      ...
      <div className="bg-zinc-100 dark:bg-zinc-900 dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-800 rounded-xl p-4 flex flex-col sm:flex-row items-center justify-between gap-3 shadow-2xs">
        ...
        <div className="flex items-center space-x-2 w-full sm:w-auto justify-end">
          ...
          <span className="px-2.5 py-1 bg-zinc-200 dark:bg-zinc-800 rounded-lg text-xs font-mono font-bold text-zinc-700 dark:text-zinc-300">
                ...
                {item.workUrl && (
                  <div className="shrink-0 self-end sm:self-center pt-2 sm:pt-0">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center space-x-1.5 px-3 py-1.5 bg-zinc-200 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-slate-700 text-zinc-700 dark:text-zinc-300 text-xs font-semibold rounded-lg transition-colors cursor-pointer"
                    >
