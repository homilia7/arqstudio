...
export const CreateProjectModal: React.FC<CreateProjectModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/75 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-fadeIn">
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl max-w-lg w-full shadow-2xl overflow-hidden text-zinc-900 dark:text-zinc-100 transition-colors">
        {/* Cabecera del Modal */}
        <div className="h-12 bg-zinc-50 dark:bg-zinc-950 px-4 flex items-center justify-between border-b border-zinc-200 dark:border-zinc-800">
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4 text-xs">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-zinc-50 focus:bg-white dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-700 rounded-lg text-zinc-900 dark:text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-emerald-500 font-medium"
              autoFocus
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-2 bg-zinc-50 focus:bg-white dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-700 rounded-lg text-zinc-900 dark:text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-emerald-500 font-mono text-[11px]"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 bg-zinc-50 focus:bg-white dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-700 rounded-lg text-zinc-900 dark:text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-emerald-500"
            />
          </div>
