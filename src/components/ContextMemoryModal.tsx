...
export const ContextMemoryModal: React.FC<ContextMemoryModalProps> = ({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-2 sm:p-4 bg-slate-950/70 backdrop-blur-xs">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg w-full max-w-3xl overflow-hidden shadow-2xl flex flex-col transition-colors">
        {/* Header */}
        <div className="px-4 py-2.5 bg-slate-50 dark:bg-slate-800/60 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              <h2 className="text-xs sm:text-sm font-bold text-slate-900 dark:text-white tracking-tight flex items-center space-x-1.5">
          ...
          <div className="flex items-center space-x-1">
            <button
              ...
              className="p-1 text-slate-500 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded transition-colors flex items-center space-x-1 text-xs font-semibold cursor-pointer"
            >
              {copied ? (
                <>
        ...
        <div className="p-3 sm:p-4 space-y-2.5">
            ...
            <div className="space-y-2.5">
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-bold text-slate-700 dark:text-slate-300 flex items-center justify-between">
                  ...
                  <span className="text-[9px] text-slate-400">({techReqs.length})</span>
                </label>
                <div className="flex space-x-1">
                  <input
                    ...
                    className="flex-1 px-2 py-1 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded text-xs text-slate-800 dark:text-slate-200 placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                  />
                  <button
                    type="button"
                    onClick={() => addItem(techReqs, setTechReqs, newReq, setNewReq)}
                    className="px-2 py-1 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold rounded flex items-center space-x-0.5 cursor-pointer"
                  >
                ...
                <div className="flex flex-wrap gap-1 max-h-14 overflow-hidden pt-0.5">
                  {techReqs.map((req, idx) => (
                    <span
                      key={idx}
                      className="inline-flex items-center space-x-1 px-1.5 py-0.5 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded text-[10px] text-slate-700 dark:text-slate-300"
                    >
                  ...
                  {techReqs.length === 0 && (
                    <span className="text-[10px] text-slate-400 italic">Sin requerimientos</span>
                  )}
                </div>
              </div>
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-bold text-slate-700 dark:text-slate-300 flex items-center justify-between">
                  ...
                  <span className="text-[9px] text-slate-400">({affectedFiles.length})</span>
                </label>
                <div className="flex space-x-1">
                  <input
                    type="text"
                    ...
                    className="flex-1 px-2 py-1 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded text-xs text-slate-800 dark:text-slate-200 placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-indigo-500 font-mono"
                  />
                  <button
                    type="button"
                    onClick={() => addItem(affectedFiles, setAffectedFiles, newFile, setNewFile)}
                    className="px-2 py-1 bg-slate-800 dark:bg-slate-700 hover:bg-slate-700 text-white text-xs font-semibold rounded flex items-center space-x-0.5 cursor-pointer"
                  >
                    <Plus className="w-3 h-3" />
                  </button>
                </div>
                <div className="flex flex-wrap gap-1 max-h-14 overflow-hidden pt-0.5">
                  ...
                  {affectedFiles.length === 0 && (
                    <span className="text-[10px] text-slate-400 italic">Sin archivos asignados</span>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2.5">
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-bold text-slate-700 dark:text-slate-300 flex items-center justify-between">
                  ...
                  <span className="text-[9px] text-slate-400">({rules.length})</span>
                </label>
                <div className="flex space-x-1">
                  <input
                    type="text"
                ...
                <div className="flex flex-wrap gap-1 max-h-14 overflow-hidden pt-0.5">
                  ...
                  {rules.length === 0 && (
                    <span className="text-[10px] text-slate-400 italic">Sin reglas declaradas</span>
                  )}
                </div>
              </div>
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-bold text-slate-700 dark:text-slate-300 flex items-center justify-between">
                  ...
                  <span className="text-[9px] text-slate-400">({deps.length})</span>
                </label>
                <div className="flex space-x-1">
                  <input
                    type="text"
                ...
                <div className="flex flex-wrap gap-1 max-h-14 overflow-hidden pt-0.5">
                  ...
                  {deps.length === 0 && (
                    <span className="text-[10px] text-slate-400 italic">Sin dependencias</span>
                  )}
                </div>
              </div>
            </div>
          ...
          <div className="space-y-1 pt-1">
            <label className="block text-[10px] font-bold text-slate-700 dark:text-slate-300 flex items-center space-x-1">
            ...
            <textarea
              ...
              className="w-full px-2.5 py-1.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded text-xs text-slate-800 dark:text-slate-200 placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-indigo-500 leading-tight resize-none font-mono"
            />
          </div>
        </div>
        ...
        <div className="px-4 py-2.5 bg-slate-50 dark:bg-slate-800/60 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between">
          <button
            type="button"
            onClick={onClose}
            className="px-3 py-1 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-semibold rounded border border-slate-200 dark:border-slate-700 transition-colors cursor-pointer shadow-2xs"
          >
            Cancelar
          </button>
          <button
            ...
            onClick={handleSave}
            disabled={isSaving}
            className="px-3.5 py-1 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded transition-colors shadow-2xs flex items-center space-x-1.5 cursor-pointer disabled:opacity-50"
          >
