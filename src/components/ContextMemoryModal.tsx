...
export const ContextMemoryModal: React.FC<ContextMemoryModalProps> = ({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-2 sm:p-4 bg-zinc-950/70 backdrop-blur-xs">
      <div className="bg-zinc-100 dark:bg-zinc-900 dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-800 rounded-lg w-full max-w-3xl overflow-hidden shadow-2xl flex flex-col transition-colors">
        {/* Header */}
        <div className="px-4 py-2.5 bg-zinc-100 dark:bg-zinc-800/60 border-b border-zinc-300 dark:border-zinc-800 flex items-center justify-between">
        ...
        <div className="p-3 sm:p-4 space-y-2.5">
            ...
            <div className="space-y-2.5">
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-bold text-zinc-700 dark:text-zinc-300 flex items-center justify-between">
                  ...
                  <span className="text-[9px] text-zinc-400">({techReqs.length})</span>
                </label>
                <div className="flex space-x-1">
                  <input
                    ...
                    className="flex-1 px-2 py-1 bg-zinc-100 dark:bg-zinc-900 dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-700 rounded text-xs text-zinc-800 dark:text-zinc-200 placeholder:text-zinc-400 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                  />
                  <button
                    type="button"
                ...
                <div className="flex flex-wrap gap-1 max-h-14 overflow-hidden pt-0.5">
                  ...
                  {techReqs.length === 0 && (
                    <span className="text-[10px] text-zinc-400 italic">Sin requerimientos</span>
                  )}
                </div>
              </div>
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-bold text-zinc-700 dark:text-zinc-300 flex items-center justify-between">
                  ...
                  <span className="text-[9px] text-zinc-400">({affectedFiles.length})</span>
                </label>
                <div className="flex space-x-1">
                  <input
                    type="text"
                    ...
                    className="flex-1 px-2 py-1 bg-zinc-100 dark:bg-zinc-900 dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-700 rounded text-xs text-zinc-800 dark:text-zinc-200 placeholder:text-zinc-400 focus:outline-none focus:ring-1 focus:ring-indigo-500 font-mono"
                  />
                  <button
                    type="button"
                    onClick={() => addItem(affectedFiles, setAffectedFiles, newFile, setNewFile)}
                    className="px-2 py-1 bg-zinc-800 dark:bg-slate-700 hover:bg-slate-700 text-white text-xs font-semibold rounded flex items-center space-x-0.5 cursor-pointer"
                  >
                    <Plus className="w-3 h-3" />
                  </button>
                </div>
                <div className="flex flex-wrap gap-1 max-h-14 overflow-hidden pt-0.5">
                  ...
                  {affectedFiles.length === 0 && (
                    <span className="text-[10px] text-zinc-400 italic">Sin archivos asignados</span>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2.5">
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-bold text-zinc-700 dark:text-zinc-300 flex items-center justify-between">
                  ...
                  <span className="text-[9px] text-zinc-400">({rules.length})</span>
                </label>
                <div className="flex space-x-1">
                  <input
                    type="text"
                ...
                <div className="flex flex-wrap gap-1 max-h-14 overflow-hidden pt-0.5">
                  ...
                  {rules.length === 0 && (
                    <span className="text-[10px] text-zinc-400 italic">Sin reglas declaradas</span>
                  )}
                </div>
              </div>
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-bold text-zinc-700 dark:text-zinc-300 flex items-center justify-between">
                  ...
                  <span className="text-[9px] text-zinc-400">({deps.length})</span>
                </label>
                <div className="flex space-x-1">
                  <input
                    type="text"
                ...
                <div className="flex flex-wrap gap-1 max-h-14 overflow-hidden pt-0.5">
                  ...
                  {deps.length === 0 && (
                    <span className="text-[10px] text-zinc-400 italic">Sin dependencias</span>
                  )}
                </div>
              </div>
            </div>
          ...
          <div className="space-y-1 pt-1">
            ...
            <textarea
              ...
              className="w-full px-2.5 py-1.5 bg-zinc-100 dark:bg-zinc-900 dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-700 rounded text-xs text-zinc-800 dark:text-zinc-200 placeholder:text-zinc-400 focus:outline-none focus:ring-1 focus:ring-indigo-500 leading-tight resize-none font-mono"
            />
          </div>
        </div>

        {/* Footer */}
        <div className="px-4 py-2.5 bg-zinc-100 dark:bg-zinc-800/60 border-t border-zinc-300 dark:border-zinc-800 flex items-center justify-between">
          <button
            type="button"
            onClick={onClose}
