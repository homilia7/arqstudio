      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div>
          <textarea
            ...
            className="w-full px-3.5 py-2.5 bg-zinc-50 focus:bg-white dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-700 rounded-lg text-xs text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 dark:placeholder-zinc-500 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-all font-sans leading-relaxed"
            required
          />
        </div>
        ...
        <div className="flex flex-wrap items-center gap-1.5 pt-1">
          ...
          {quickTemplates.map((template, idx) => (
            <button
              ...
              className="text-[11px] bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 text-zinc-700 dark:text-zinc-300 border border-zinc-200 dark:border-zinc-700/60 px-2.5 py-1 rounded transition-colors cursor-pointer"
            >
              {template.slice(0, 30)}...
            </button>
          ))}
        ...
        <div className="pt-2 border-t border-zinc-300/80 dark:border-zinc-800/80">
          ...
          {showAdvanced && (
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-3 p-3 bg-zinc-50 dark:bg-zinc-950 rounded-lg border border-zinc-200 dark:border-zinc-800 animate-fadeIn">
              <div>
                ...
                <input
                  ...
                  className="w-full px-2.5 py-1.5 bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded text-xs text-zinc-900 dark:text-zinc-100 focus:outline-none focus:border-emerald-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="https://..."
                  className="w-full px-2.5 py-1.5 bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded text-xs text-zinc-900 dark:text-zinc-100 focus:outline-none focus:border-emerald-500 font-mono text-[11px]"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-2.5 py-1.5 bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded text-xs text-zinc-900 dark:text-zinc-100 focus:outline-none focus:border-emerald-500 font-medium"
                >
