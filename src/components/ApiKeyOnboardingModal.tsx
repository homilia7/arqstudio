...
- Notificación obligatoria: POST ${baseUrl}/agent/notify-user con estado de progreso en vivo.`;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/80 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="bg-white dark:bg-[#0e1117] border border-zinc-200 dark:border-zinc-200 dark:border-zinc-800 rounded-xl shadow-2xl text-zinc-800 dark:text-zinc-200 w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden text-zinc-200">
        ...
        <div className="p-4 sm:p-5 space-y-4 overflow-y-auto text-xs text-zinc-300">
          ...
          <div className="p-3.5 rounded-lg bg-zinc-50 dark:bg-[#12151b] border border-zinc-200 dark:border-zinc-800 space-y-2">
            ...
            <div className="flex items-center justify-between text-[11px] text-zinc-500 font-mono">
              <span>Endpoint Base: <code className="text-zinc-600 dark:text-zinc-400">{baseUrl}</code></span>
              <span>Project ID: <code className="text-zinc-600 dark:text-zinc-400">{projectId}</code></span>
            </div>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-bold text-zinc-600 dark:text-zinc-400 uppercase tracking-wider flex items-center gap-1.5">
          ...
          {/* Steps */}
          <div className="p-3 rounded bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 space-y-2 text-[11px]">
