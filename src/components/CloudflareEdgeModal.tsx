...
export const CloudflareEdgeModal: React.FC<CloudflareEdgeModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/80 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="bg-[#0e1117] border border-zinc-800 rounded-xl shadow-2xl w-full max-w-3xl flex flex-col overflow-hidden text-zinc-200">
        ...
        {/* Metrics Grid */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5 p-4 bg-[#12151b] border-b border-zinc-800 text-xs">
          <div className="p-2.5 rounded bg-[#090b0e] border border-zinc-800/80 space-y-1">
        ...
        <div className="p-4 sm:p-5 space-y-3 overflow-y-auto text-xs text-zinc-300 max-h-72">
          <div className="p-3 rounded-lg bg-[#12151b] border border-zinc-800 flex items-start gap-3">
            <div className="p-2 rounded bg-orange-950/40 border border-orange-800/50 text-orange-400 shrink-0">
              <Database className="w-4 h-4" />
            </div>
            <div>
              <h4 className="font-bold text-white text-xs">Cloudflare D1 Serverless SQL</h4>
          ...
          <div className="p-3 rounded-lg bg-[#12151b] border border-zinc-800 flex items-start gap-3">
            ...
            <div>
              <h4 className="font-bold text-white text-xs">Edge Workers & Functions</h4>
              <p className="text-zinc-400 text-[11px] mt-0.5">
          ...
          <div className="p-3 rounded-lg bg-[#12151b] border border-zinc-800 flex items-start gap-3">
            ...
            <div>
              <h4 className="font-bold text-white text-xs">Memoria Vectorial & Cache</h4>
              <p className="text-zinc-400 text-[11px] mt-0.5">
        ...
        {/* Footer */}
        <div className="px-4 py-3 bg-[#16191f] border-t border-zinc-800 flex items-center justify-between text-xs">
