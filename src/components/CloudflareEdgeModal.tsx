...
export const CloudflareEdgeModal: React.FC<CloudflareEdgeModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/80 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="bg-white dark:bg-[#0e1117] border border-zinc-200 dark:border-zinc-200 dark:border-zinc-800 rounded-xl shadow-2xl text-zinc-800 dark:text-zinc-200 w-full max-w-3xl flex flex-col overflow-hidden text-zinc-200">
        ...
        <div className="p-4 sm:p-5 space-y-3 overflow-y-auto text-xs text-zinc-300 max-h-72">
          <div className="p-3 rounded-lg bg-zinc-50 dark:bg-[#12151b] border border-zinc-200 dark:border-zinc-200 dark:border-zinc-800 flex items-start gap-3">
        ...
        {/* Footer */}
        <div className="px-4 py-3 bg-[#16191f] border-t border-zinc-200 dark:border-zinc-800 flex items-center justify-between text-xs">
