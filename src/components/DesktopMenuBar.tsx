      ...
      <header className="bg-[#0b0d10] text-zinc-400 border-b border-[#1c2027] text-[12px] font-sans select-none flex items-center justify-between px-3 h-9 z-50 relative shrink-0 overflow-visible">
        ...
        <div className="flex items-center gap-1.5 shrink-0 overflow-visible">
          ...
          <div className="flex items-center gap-1.5 pr-2 border-r border-zinc-800 shrink-0">
            ...
            <span className="font-bold text-white tracking-tight text-[12px]">AgentOS</span>
            <span className="text-[9px] text-zinc-400 font-mono px-1 py-0.2 rounded bg-zinc-900 border border-zinc-800">
              v2.4
            </span>
          </div>
          ...
          <nav className="flex items-center gap-0.5 shrink-0">
            ...
            <div className="relative">
              ...
              {activeDropdown === 'archivo' && (
                <div className="absolute left-0 mt-0.5 w-52 bg-[#12151b] border border-zinc-800 rounded-lg shadow-2xl py-1 z-50 text-zinc-200 text-xs animate-in fade-in zoom-in-95 duration-100">
                  <button
                    onClick={() => { onOpenNewProject(); closeDropdown(); }}
                    className="w-full text-left px-3 py-1.5 hover:bg-zinc-800/80 hover:text-white flex items-center gap-2 cursor-pointer transition-colors"
                  >
            ...
            <div className="relative">
              ...
              {activeDropdown === 'supervisor' && (
                <div className="absolute left-0 mt-0.5 w-60 bg-[#12151b] border border-zinc-800 rounded-lg shadow-2xl py-1 z-50 text-zinc-200 text-xs animate-in fade-in zoom-in-95 duration-100">
                  <button
            ...
            <div className="relative">
              ...
              {activeDropdown === 'memoria' && (
                <div className="absolute left-0 mt-0.5 w-56 bg-[#12151b] border border-zinc-800 rounded-lg shadow-2xl py-1 z-50 text-zinc-200 text-xs animate-in fade-in zoom-in-95 duration-100">
                  <button
            ...
            <button
              ...
              className="px-2.5 py-1 rounded text-xs text-zinc-300 hover:text-white hover:bg-zinc-800/60 transition-colors flex items-center gap-1.5 cursor-pointer font-medium"
            >
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2 py-0.5 rounded bg-emerald-950/70 border border-emerald-800/80 text-emerald-300 hover:bg-emerald-900/90 transition-colors cursor-pointer text-[11px] font-medium"
          >
          ...
          <button
            ...
            className="flex items-center gap-1 px-2 py-0.5 rounded bg-amber-950/70 border border-amber-800/80 text-amber-300 hover:bg-amber-900/90 transition-colors cursor-pointer text-[11px] font-mono"
          >
          ...
          <button
            ...
            className="p-1 rounded bg-rose-950/70 border border-rose-800/80 text-rose-300 hover:bg-rose-900 transition-colors cursor-pointer"
          >
            <ShieldAlert className="w-3.5 h-3.5 text-rose-400" />
          </button>
          ...
          <button
            ...
            className="p-1 rounded bg-orange-950/70 border border-orange-800/80 text-orange-300 hover:bg-orange-900 transition-colors cursor-pointer"
          >
            <Database className="w-3.5 h-3.5 text-orange-400" />
          </button>
          ...
          <button
            ...
            className="relative p-1 rounded hover:bg-zinc-800 text-zinc-300 hover:text-white transition-colors cursor-pointer"
          >
          ...
          <button
            ...
            className="p-1 rounded hover:bg-zinc-800 text-zinc-300 hover:text-white transition-colors cursor-pointer"
          >
          ...
          <div className="relative pl-1 border-l border-zinc-800 shrink-0">
            <button
            ...
            >
              ...
              <span className="font-semibold text-[11px] text-zinc-200 truncate">
            ...
            {activeDropdown === 'user-profile' && (
              <div className="absolute right-0 mt-0.5 w-48 bg-[#12151b] border border-zinc-800 rounded-lg shadow-2xl py-1 z-50 text-zinc-200 text-xs animate-in fade-in zoom-in-95 duration-100">
                <div className="px-3 py-1.5 border-b border-zinc-800 text-[11px]">
                ...
                <button
                  onClick={() => { onOpenMyAccount(); closeDropdown(); }}
                  className="w-full text-left px-3 py-1.5 hover:bg-zinc-800/80 hover:text-white flex items-center gap-2 cursor-pointer transition-colors text-xs"
                >
                  <Key className="w-3.5 h-3.5 text-amber-400" />
                  <span>Mi Cuenta & PIN</span>
                </button>
